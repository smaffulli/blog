...
![With Kubecost, you can share AKS clusters and still clearly allocate shared costs.](2021-04-28-aks-cost/image1.png "With Kubecost, you can share AKS clusters and still clearly allocate shared costs.")


With Kubecost, you can share AKS clusters and still clearly allocate shared costs.
...
_An accurate cost allocation by project, team, or cost center must consider all factors._
...
A comprehensive view should include AKS-related and non-AKS-related costs
...
Kubecost uses the Microsoft Azure Billing Rate Card API to gather accurate and detailed cost information
...
Kubecost’s main dashboard summarizes costs, health, and efficiency
...
AKS costs in Kubecost include in-cluster costs, out-of-cluster or external costs, and shared costs.
...
Kubecost cost allocation report for Azure AKS
...
Kubecost’s Detailed Azure Cost View
...
Allocation of shared costs are controlled in the Kubecost Settings page 
...
The Assets view shows all Azure spending, not just AKS
...
Click to drill down into a detailed itemized view of costs
...
Azure integration information is entered in the Kubecost Settings page
